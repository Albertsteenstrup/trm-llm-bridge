...
Code here is separate from third-party datasets and model weights. Sudoku puzzles come
from `sapientinc/sudoku-extreme`; the TRM follows the SamsungSAIL TinyRecursiveModels
project; CLRS/ReNAR follows the ReNAR project and DeepMind CLRS. Verify upstream licenses
before redistributing any data or model artifact.
